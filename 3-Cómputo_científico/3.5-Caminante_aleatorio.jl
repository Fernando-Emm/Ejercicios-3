...
# ╔═╡ ff9759af-2f3b-4d4e-9481-31f8c67a8044
using Plots
...
function aleatorioUniforme(a, b)
    aleatoriouniforme= a + (b - a) * rand()
end

# ╔═╡ 8f75ecf3-090e-4937-80a8-658b45f9fa3f
aleatorioUniforme(1,2)
...
function verificarDistribucionUniforme(c, d, x)          #definimos la función y sus variables
    
    muestra = [aleatorioUniforme(c, d) for _ in 1:x]     

    
    histograma = histogram(muestra, bins = 20, xlabel = "Valor", ylabel = "Frecuencia", color = "green", #creamos un histogrma
...
# ╔═╡ 9f8e8254-53f8-44ea-8659-d620843af837
c=3

# ╔═╡ df38dfe9-4321-4f8d-9f4b-d298037e033a
d=1

# ╔═╡ 13dc7dd9-b75d-4dec-9c16-63d54f240367
x=100

# ╔═╡ d9a707e2-58df-4306-a15b-8eae7dcd783c
histograma = verificarDistribucionUniforme(c, d, x)

# ╔═╡ 10f27be4-fdbd-43fc-8ffd-b7451aad154d
display(histogama)
...
# Tu código va aquí :)
function unPaso()
    unPaso= 2 * rand(Bool) - 1
end

# ╔═╡ 5103c814-fb69-4d75-a1bd-c715f9078fc2
result= unPaso()

# ╔═╡ a5655e76-e2c4-41a7-b197-1cce4ea10f8e
print(result)
...
function variosPasos(i)
    variosPasos= 2 .* rand(Bool, i) .- 1
end

# ╔═╡ 26b41cec-aaf6-4423-9a53-9192f34edf62
variosPasos(1)
...
# ╔═╡ 095f4cea-62da-401c-a5ad-6a4d0b11df79
